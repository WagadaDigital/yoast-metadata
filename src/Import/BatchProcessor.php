...
final class BatchProcessor {
     ...
     * @param bool                              $skip_existing Skip posts with existing meta description.
    ...
    private function process_rows( array $rows, bool $skip_existing = false ): array {
        ...
        foreach ( $rows as $row ) {
            ...
            // Skip posts that already have meta description if option is enabled.
            if ( $skip_existing ) {
                $existing_meta = $this->meta_handler->get_meta( $post_id );
