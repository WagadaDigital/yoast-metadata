...
<div class="yoast-metadata-card">
    <h2><?php esc_html_e( 'Export Taxonomies to CSV', 'yoast-metadata' ); ?></h2>

    <form id="yoast-metadata-taxonomy-export-form" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
        <input type="hidden" name="action" value="<?php echo esc_attr( Plugin::PREFIX . 'export_taxonomy_csv' ); ?>">
        ...
        <div class="yoast-metadata-export-options">
            <div class="yoast-metadata-export-option">
                <label><?php esc_html_e( 'Taxonomies', 'yoast-metadata' ); ?></label>
            ...
            <div class="yoast-metadata-export-option">
                ...
                <div class="yoast-metadata-checkbox-list">
                    <label>
                        <input type="checkbox" name="empty_meta" id="yoast-metadata-taxonomy-empty-meta" value="1">
                        <?php esc_html_e( 'Only terms without SEO metadata', 'yoast-metadata' ); ?>
                    </label>
                    <label>
                        <input type="checkbox" name="has_meta" value="1">
                        <?php esc_html_e( 'Only terms with SEO metadata', 'yoast-metadata' ); ?>
                    </label>
                </div>
            </div>
        </div>

        <div class="yoast-metadata-export-count" id="yoast-metadata-taxonomy-export-count">
    ...
    <table class="widefat striped" style="max-width: 800px;">
        ...
        <tbody>
            <tr>
                ...
                <td><?php esc_html_e( 'The term slug (used for import identification)', 'yoast-metadata' ); ?></td>
            </tr>
            <tr>
                <td><code>taxonomy</code></td>
                <td><?php esc_html_e( 'The taxonomy type (category, post_tag, product_cat, etc.)', 'yoast-metadata' ); ?></td>
            </tr>
            <tr>
                <td><code>name</code></td>
                <td><?php esc_html_e( 'The term name (for reference only)', 'yoast-metadata' ); ?></td>
            </tr>
            <tr>
                <td><code>url</code></td>
                <td><?php esc_html_e( 'The term archive URL (for reference only)', 'yoast-metadata' ); ?></td>
            </tr>
            <tr>
